...
# show the image 
cv2.imshow("AKANKSHA SHARMA Car Detector App", car_img)
...
cv2.imshow("AKANKSHA SHARMA Car Detector App", grayscaled_car_img)
cv2.waitKey(1000) # debug
...
while True:
    ...
    # show the video
    cv2.imshow("AKANKSHA SHARMA Car Detector App", frame)
